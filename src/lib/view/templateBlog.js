  ...
  <article class="entrance3">
   ...
   <article class="entrance2">
    ...
    <section class="postContainer">
      ...
      <div id="post3"></div>
      <div id="post4">
      <h3>La diferencia entre lager y ale, explicada</h3>
      <p> <img src="./img/blog/ale-lager.jpeg" align="left"> Cuando se trata de cervezas, no hay más palabras que se repitan más como "ale"y "lager". Esto no es extraño, ya que todas la cervezas caen en al menos una de estas categorías, pero muchos de nosotros hemos ido por un camino de mala educación cuando se trata de distinguir a este par. Pero no temas: estamos aquí para ayudarte a comprender las diferencias entre las dos. </p>
      <h2>La lager es mi estilo favorito, ¿qué puedes decirme de ella?</h2>
      <p>Bueno, a pesar de lo que el marketing perezoso de las macrocervecerías puede hacerte creer, no es un estilo; lager es una categoría amplia de muchos estilos diferentes. La distinción entre ales y lager puede hacer que sea mucho más fácil encontrar una cerveza que te guste.<br>
      ...
      <h3>¿Cuáles son algunos ejemplos populares de cada tipo?</h3>
      ...
      <h3>Esto parece muy básico. ¿Por qué es tan difícil de entender?</h3>
